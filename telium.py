...
def output_module():
    ...
    print("\033[34m-----------------------------------------------------------------")
    print()
    print("You are in room",module, "\033[34m")
    print()

def output_moves():
    global possible_moves
    print()
    print("\033[34mFrom here you can move to rooms:  ",end='| ', )
...
def get_action():
    ...
    while valid_action == False:
        print("\033[34mWhat do you want to do next ? (MOVE, LOCK)")
        action = input(">")
        if action == "MOVE":
            try:
                ...
                if move in possible_moves:
                    ...
                    print("\033[31mThe room must be connected to the current room.\033[0m")
            except:
                print("\033[31mInvalid.\033[0m")
        
        if action == "LOCK":
            print("\033[34mcurrent redstone power: ",redstone, ".")
...
def check_mine_shafts():
    ...
    if module in mine_shafts:
        print("\033[32mThere is an anvil here.")
        print("\033[34mYou use it to repair your flint and steel and sword.")
        durability_gained = 50
        print("Durability was ",durability,". It is now at ",durability+durability_gained,".\033[0m")
        durability = durability + durability_gained
        print("\033[33mYou hear hissing from the surrounding doors!")
        ...
        print("You dig into the wooden floor and begin tunneling.\033[0m")
        last_module = module
...
def lock():
    ...
    new_lock = int(input("\033[34mEnter room to lock doors to:"))
    if new_lock < 0 or new_lock > num_modules:
        print("\033[31mThat is not a room.\033[0m")
    elif new_lock == charged_creeper:
        print("\033[31mSorry but that room can not currently be locked...\033[0m")
    else:
        locked = new_lock
        print("\033[32mMobs cannot enter room",locked)
        redstone_used = 25 + 5 * random.randint(0,5)
        redstone = redstone - redstone_used
        print("\033[33mredstone power now: ", redstone, ".\033[0m")
...
def move_charged_creeper():
    ...
    if module == charged_creeper:
        print("\033[33mThe charged creeper is in this room!")
        print("It has not spotted you.\033[0m")
        ...
        while moves_to_make > 0:
            ...
            if len(moves) == 0:
                won = True
                moves_to_make = 0
                print("\033[32mIt cannot move anymore! Strike!\033[0m")
            #otherwise move it to an ajacent module
            else:
                if moves_to_make == 1:
                    print("\033[32mIt moves on to another room. Phew.\033[0m")
                ...
                while charged_creeper in mine_shafts:
                    if moves_to_make > 0:
                        print("\033[32mIt moves on to another room. Phew.\033[0m")
                    print("\033[33mYou hear footsteps on the ceiling. It appears to be in the area where the redstone power travels in the base.\033[0m")
                    valid_move = False
...
def intuition():
    ...
    for connected_module in possible_moves:
        if connected_module in creepers:
            print("\033[33mYou hear footsteps and hissing coming from nearby...\033[0m")
        if connected_module in mine_shafts:
            print("\033[33mYour flint and steel feel like they could do with a repair... There must be an anvil somewhere nearby...\033[0m")
        if connected_module in info_signs:
            print("\033[33mYou wish you could remember the layout of your base. Perhaps there is some way to find out?\033[0m")

def normal_creepers():
    global module, creepers, durability, alive
    #output encounter
    if module in creepers:
        print("\033[33mA creeper is in this room. It is not the charged creeper but has somehow entered the base.")
        print("It turns around, hisses and begins walking towards you.\033[0m")
        #get action
        succesful_attack = False
        while succesful_attack == False:
            print("\033[33myou can:")
            print()
            print("-----Hit it with a sword to push it backward so you can get out the room.")
            print("-----Use your flint and steel to force it to explode then run.\033[0m")
            print()
            action = 0
            while action not in ("S", "F"):
                action = input("\033[34mWhat will you do? sword:(S) flint+steel:(F)")
            ...
            if durability <= 0:
                print("\033[31mYou do not have enough durability to hit it hard enough and it explodes.\033[0m")
                alive = False
                return
            ...
            if dur_used >= dur_needed:
                ...
                if action == "S":
                    print("\033[33mYou hit it but not hard enough. It is only knocked back a bit. You cannot escape in this window but you can hit it again.\033[0m")
                if action == "F":
                    print("\033[33mYou strike your flint and steel but it only produses a few sparks. The creeper steps backwards and dodges, however, this gives you chance to strike again.\033[0m")
        #if its successful...
        if action == "S":
            print("\033[32mThe creeper is launched backward into the corner of the room giving you chance to escape.\033[0m")
        if action == "F":
            print("\033[32mYou light the creeper then run. You  see it detonate out of the corner of your eye. This room is now safe.\033[0m")
...
def information_signs():
    ...
    if module in info_signs:
       print("\033[32mYou notice a sign stuck in the ground here. It appears to have some information written on it.")
       print()
       print("\033[34mIt reads:")
       print()
       print("The charged creeper is located in room:",charged_creeper)
       randnum = random.randint(0,3)
       if randnum == 1:
           print("Anvils are located in rooms",mine_shafts, "\033[0m")
       elif randnum == 2:
          print("Informational signs are located in rooms:",info_signs, "\033[0m")
       elif randnum == 3:
          print("Normal creepers are located in rooms:",creepers, "\033[0m")
...
if won == True:
    print("\033[32mThe charged creeper is trapped and you detonate it with your flint and steel.")
    print()
    print("BOOM!")
    print()
